...
public class Utils {
     ...
     * 手机号过滤
     */
    public static String filtrationPhone(String Phone) {
     ...
     * 呢称过滤
     */
    public static String filtrationName(String Name) {
        String suffix = "*";
        if(Name.length() >= 2){
     ...
     * @return
     */
    public static Integer getPserial(){
        return Pserial;
    }
     ...
     * @return
     */
    public static void setPserial(Integer pserial){
        Pserial =  pserial;
    }
